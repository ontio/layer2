...
type OntologyClient interface {
	...
	getLayer2State(qid string, height uint32) ([]byte, error)
}
...
const (
	...
	RPC_GET_LAYER2_STATE            = "getlayer2state"
)
...
const (
	...
	GET_LAYER2_STATE     = "/api/v1/getlayer2state/"
)
...
const (
	...
	WS_ACTION_GET_LAYER2_STATE             = "getlayer2state"
