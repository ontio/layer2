# Go SDK For Ontology Layer2

* [Go SDK For Ontology Layer2](#go-sdk-for-ontology)
	...
	* [2. How to use?](#2-how-to-use)
		* [2.1 Block Chain API](#21-block-chain-api)
			...
			* [2.1.9 Send transaction to Layer2](#219-send-transaction-to-ontology)
			* [2.1.10 Get the state of Layer2](#2110-get-the-state-of-layer2)
...
## 1. Overview
This is a comprehensive Go library for the Ontology Layer2. Currently, it supports local wallet management, digital asset management. In the future it will also support more rich functions and applications.
...
#### 2.1.9 Send transaction to Layer2

```
ontSdk.SendTransaction(mutTx *types.MutableTransaction) (common.Uint256, error)
```

#### 2.1.10 Get the state of Layer2

```
ontSdk.GetLayer2State(height uint32) (*sdkcom.Layer2State, []keypair.PublicKey, error)
```
