...
func (this *WSClient) getLayer2State(qid string, height uint32) ([]byte, error) {
	return this.sendSyncWSRequest(qid, WS_ACTION_GET_LAYER2_STATE, map[string]interface{}{"Height": height})
}
